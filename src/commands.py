...
HELP_TEXT = (
    "راهنمای ربات وظایف:\n\n"
    "🔑 قاعده ساخت تسک: **جمله رو با اسم طرف مقابل شروع کن**، بعد کار رو بنویس.\n"
    "   مثال: «فرزان لطفا فاکتورهای این ماه رو ثبت کن»\n"
    "   هر پیامی که با اسم شروع بشه تسک می‌شه و به همون نفر ارجاع داده می‌شه.\n"
    "   بقیه پیام‌های گروه دست نخورده می‌مونن و ربات کاری باهاشون نداره.\n\n"
    "ذکر ددلاین اجباری نیست — اگه ننویسی، با دکمه‌های روی کارت تعیینش می‌کنی.\n\n"
